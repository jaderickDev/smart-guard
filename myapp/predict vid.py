...
model = YOLO("C:/Users/Jaderick/Desktop/detectionalgo/runs/detect/train2/weights/18k_openvino_model/best.pt")
...
capture_thread.daemon = True  # This allows the thread to exit when the main program exits
